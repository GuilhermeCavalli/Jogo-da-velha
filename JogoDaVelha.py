...
def jogo(): #Funcao responsavel por tudo o que acontece dentro do jogo
  ...
  if adversario == 1:
      ...
      jogar_novamente() #Chama a função jogar novamente, para saber se o jogador deseja continuar jogando 
        ...
        while(jogando and not ganhador and not verificar_velha()): #Indica uma repeticao que será feita enquanto jogando for igual a True e verificar velha e ganhador retornarem False
            ...
            if not ganhador: 
              while not verificar_jogada(jogada_pc): #Enquanto verificar joga for falso essa repeticao sera feita, com parametro "jogada pc"
        ...
        jogar_novamente() #Chama a funcao jogar novamente
